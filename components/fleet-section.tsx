...
const vehicles = [
  ...
  },
  {
    ...
    images: ["/fleet/kia-rio-clean4.jpg"],
    price: 75,
  },
  {
    id: 9,
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent pt-16 pb-3 px-4">
                  ...
                  <p className="text-white/80 text-xs">
                    {vehicle.category === "transfer"
                      ...
                      : <>
                          {vehicle.transmission === "Manual" ? t("Manual", "Manual") : vehicle.transmission.includes("Manual") ? t("Automatic / Manual", "Automático / Manual") : t("Automatic", "Automático")}
                          {" · "}
                          {vehicle.passengers} {t("passengers", "pasajeros")}
                        </>
                    }
                ...
                {vehicle.category !== "transfer" && <div className="border-t border-border pt-3 mb-4">
                  <div className="grid grid-cols-2 gap-2.5 text-sm text-muted-foreground">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span>{vehicle.transmission === "Manual" ? t("Manual", "Manual") : vehicle.transmission.includes("Manual") ? t("Automatic / Manual", "Automático / Manual") : t("Automatic", "Automático")}</span>
                    </div>
                    {/* 5. A/C or Helmets */}
                    {vehicle.ac && (
                      <div className="flex items-center gap-1.5">
